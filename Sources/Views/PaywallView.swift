...
struct PaywallView: View {
    ...
    private let benefits: [(String, String, String)] = [
        ("infinity", "Unlimited events", "Count down to everything that matters"),
        ("face.smiling", "Emoji & colors", "Personalize every event"),
        ("pin.fill", "Menu-bar pin", "Choose which countdown shows up top"),
        ...
        VStack(spacing: 0) {
            ZStack(alignment: .topTrailing) {
                VStack(spacing: 6) {
                    ...
                    Text("Untill Pro").font(.title2.bold()).foregroundStyle(.white)
                ...
                ForEach(benefits, id: \.0) { b in
                    HStack(spacing: 11) {
                        ...
                        VStack(alignment: .leading, spacing: 1) {
                            ...
                            Text(b.2).font(.caption).foregroundStyle(Color.secondary)
                        }
                        Spacer()
                    }
                }
